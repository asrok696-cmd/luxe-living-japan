document.addEventListener("DOMContentLoaded", () => {
 ...
 "luna-lounge-sofa-150-white": {
  ...
  mainCategory: "ソファ",
  subCategory: "2人掛けソファ",
  slug: "luna-lounge-sofa-150-white",
  canonicalPath: "/products/sofas/luna-lounge-sofa-150-white",
  brand: "Luxe Living Japan",
  sku: "luna-lounge-sofa-150",
  price: 196900,

  name: "ルーナ ラウンジソファ 150 ホワイト",
  seoTitle: "【送料無料】ルーナ ラウンジソファ 150 ホワイト | 2人掛けモダンソファ",
  seoDescription:
    "ルーナ ラウンジソファ 150 ホワイトは、丸みのある背もたれと上質な座り心地が魅力の2人掛けモダンソファ。リビングを洗練された空間に整えます。送料無料。",
  keywords: [
    "ソファ",
    "2人掛けソファ",
    "ラウンジソファ",
  ...
  "bubble-sofa-270": {
    ...
    mainCategory: "ソファ",
    subCategory: "3人掛けソファ",
    slug: "bubble-sofa-270-beige",
    canonicalPath: "/products/sofas/bubble-sofa-270-beige",
    brand: "Luxe Living Japan",
    sku: "bubble-sofa-270",
    price: 262900,

    name: "バブルソファー 270 ベージュ",
    seoTitle: "バブルソファー 270 ベージュ | 3人掛け モダンソファ | Luxe Living Japan",
    seoDescription:
      "バブルソファー 270 ベージュは、ふっくらとした彫刻的フォルムが魅力の3人掛けモダンソファ。上質で洗練されたリビング空間を演出します。送料無料。",
    keywords: [
      "ソファ",
      "3人掛けソファ",
      "バブルソファ",
  ...
  "luna-curve-sofa-260": {
    ...
    mainCategory: "ソファ",
    subCategory: "L字ソファ",
    slug: "luna-curve-sofa-260-beige",
    canonicalPath: "/products/sofas/luna-curve-sofa-260-beige",
    brand: "Luxe Living Japan",
    sku: "luna-curve-sofa-260",
    price: 218900,

    name: "ルーナ カーブソファ 260 ベージュ",
    seoTitle: "ルーナ カーブソファ 260 ベージュ | L字 モダンソファ | Luxe Living Japan",
    seoDescription:
      "ルーナ カーブソファ 260 ベージュは、ダブルシェーズ付きのL字型カーブソファ。上品なベージュカラーとゆったりした座り心地で、洗練されたリビング空間を演出します。送料無料。",
    keywords: [
      "ソファ",
      "L字ソファ",
      "カーブソファ",
  ...
  "ceres-quilted-bed-frame": {
    category: "ベッド",
    mainCategory: "ベッド",
    subCategory: "ダブルベッドフレーム",
    slug: "ceres-quilted-bed-frame-white",
    canonicalPath: "/products/beds/ceres-quilted-bed-frame-white",
    brand: "Luxe Living Japan",
    sku: "luxebed140",
    price: 196900,

    name: "セレス キルティングベッドフレーム",
    seoTitle: "セレス キルティングベッドフレーム | ダブル 140cm対応 ベッド | Luxe Living Japan",
    seoDescription:
      "セレス キルティングベッドフレームは、ホワイトカラーと立体的なキルティングデザインが魅力のダブルベッドフレーム。140cmマットレス対応。送料無料。",
    keywords: [
      "ベッド",
      "ベッドフレーム",
      "ダブルベッド",
  ...
  "nova-bed-frame": {
    category: "ベッド",
    mainCategory: "ベッド",
    subCategory: "高級ベッドフレーム",
    slug: "nova-bed-frame-beige",
    canonicalPath: "/products/beds/nova-bed-frame-beige",
    brand: "Luxe Living Japan",
    sku: "luxebed140",
    price: 185900,

    name: "ノヴァ ベッドフレーム",
    seoTitle: "ノヴァ ベッドフレーム | ダブル・クイーン・キング対応 高級ベッド | Luxe Living Japan",
    seoDescription:
      "ノヴァ ベッドフレームは、ベージュカラーと立体感のあるデザインが魅力のラグジュアリーベッドフレーム。140cm・150cm・160cm・180cmマットレス対応。送料無料。",
    keywords: [
      "ベッド",
      "ベッドフレーム",
      "高級ベッド",
  ...
  "olvia-bed-frame": {
    ...
    mainCategory: "ベッド",
    subCategory: "高級ベッドフレーム",
    slug: "olvia-bed-frame-beige",
    canonicalPath: "/products/beds/olvia-bed-frame-beige",
    brand: "Luxe Living Japan",
    sku: "luxebed140-x",
    price: 185900,

    name: "オルビア ベッドフレーム",
    seoTitle: "オルビア ベッドフレーム | ダブル・クイーン・キング対応 高級ベッド | Luxe Living Japan",
    seoDescription:
      "オルビア ベッドフレームは、ベージュカラーとやわらかな立体フォルムが魅力のラグジュアリーベッドフレーム。140cm・150cm・160cm・180cmマットレス対応。送料無料。",
    keywords: [
      "ベッド",
      "ベッドフレーム",
      "高級ベッド",
  ...
  "natural-wood-bed-frame": {
    category: "ベッド",
    mainCategory: "ベッド",
    subCategory: "木製ベッドフレーム",
    slug: "natural-wood-bed-frame",
    canonicalPath: "/products/beds/natural-wood-bed-frame",
    brand: "Luxe Living Japan",
    sku: "luxelivingbed08",
    price: 75900,

    name: "ナチュラル ウッドベッドフレーム",
    seoTitle: "ナチュラル ウッドベッドフレーム | 木製ベッド シングル〜キング | Luxe Living Japan",
    seoDescription:
      "ナチュラル ウッドベッドフレームは、木のぬくもりを感じられるシンプルで上質な木製ベッド。シングルからキングまで対応し、北欧・ナチュラル・モダンな寝室に調和します。",
    keywords: [
      "ベッド",
      "木製ベッド",
      "ウッドベッドフレーム",
  ...
  "modern-luxury-bed-frame-160": {
    category: "ベッド",
    mainCategory: "ベッド",
    subCategory: "ラグジュアリーベッドフレーム",
    slug: "modern-luxury-bed-frame-160",
    canonicalPath: "/products/beds/modern-luxury-bed-frame-160",
    brand: "Luxe Living Japan",
    sku: "luxebed160",
    price: 108900,

    name: "モダン ラグジュアリーベッドフレーム",
    seoTitle: "モダン ラグジュアリーベッドフレーム | シングル〜キング対応 | Luxe Living Japan",
    seoDescription:
      "モダン ラグジュアリーベッドフレームは、静音設計とクッション性ヘッドボードを備えた上質なベッド。シングルからキングまで対応し、洗練された寝室空間を演出します。",
    keywords: [
      "ベッド",
      "ベッドフレーム",
      "ラグジュアリーベッド",
  ...
  "premium-luxury-bed-frame-140": {
    ...
    mainCategory: "ベッド",
    subCategory: "高級ベッドフレーム",
    slug: "premium-luxury-bed-frame-140",
    canonicalPath: "/products/beds/premium-luxury-bed-frame-140",
    brand: "Luxe Living Japan",
    sku: "luxebed140",
    price: 174900,

    name: "プレミアム ラグジュアリーベッドフレーム 140",
    seoTitle: "プレミアム ラグジュアリーベッドフレーム 140 | 高級ベッド | Luxe Living Japan",
    seoDescription:
      "プレミアム ラグジュアリーベッドフレーム 140 は、丸みのあるフォルムとクッション性ヘッドボードが魅力の高級ベッド。シングルからキングまで対応し、ホテルライクな寝室を演出します。",
    keywords: [
      "ベッド",
      "高級ベッド",
      "ラグジュアリーベッド",
  ...
  "modern-luxury-leather-bed-frame": {
    category: "ベッド",
    mainCategory: "ベッド",
    subCategory: "レザーベッドフレーム",
    slug: "modern-luxury-leather-bed-frame",
    canonicalPath: "/products/beds/modern-luxury-leather-bed-frame",
    brand: "Luxe Living Japan",
    sku: "luxebed160-leather",
    price: 174900,

    name: "モダン ラグジュアリーレザーベッドフレーム",
    seoTitle: "モダン ラグジュアリーレザーベッドフレーム | 高級レザーベッド | Luxe Living Japan",
    seoDescription:
      "モダン ラグジュアリーレザーベッドフレームは、丸みのあるフォルムとクッション性ヘッドボードが魅力の高級ベッド。ベージュ・ブラック展開、シングルからキングまで対応。",
    keywords: [
      "ベッド",
      "レザーベッド",
      "高級ベッド",
 ...
 "natural-storage-bed-frame-140": {
  category: "ベッド",
  mainCategory: "ベッド",
  subCategory: "収納付きベッドフレーム",
  slug: "natural-storage-bed-frame-140",
  canonicalPath: "/products/beds/natural-storage-bed-frame-140",
  brand: "Luxe Living Japan",
  sku: "luxebed140-storage",
  price: 104500,

  name: "ナチュラル ウッド収納ベッドフレーム 140",
  seoTitle: "ナチュラル ウッド収納ベッドフレーム 140 | 収納付き木製ベッド | Luxe Living Japan",
  seoDescription:
    "ナチュラル ウッド収納ベッドフレーム 140 は、跳ね上げ収納と宮棚を備えた天然木ベッド。シングルからキングまで対応し、収納力と上質なデザインを両立します。",
  keywords: [
    "ベッド",
    "収納付きベッド",
    "木製ベッド",
...
"louve-dining-table-180": {
  category: "テーブル",
  mainCategory: "ダイニングテーブル",
  subCategory: "無垢材ダイニングテーブル",
  slug: "louve-dining-table-180",
  canonicalPath: "/products/tables/louve-dining-table-180",
  brand: "Luxe Living Japan",
  sku: "luxeds06",
  price: 185900,

  name: "ルーヴェ ダイニングテーブル 180",
  seoTitle: "ルーヴェ ダイニングテーブル 180 | 無垢材 180cm ダイニングテーブル | Luxe Living Japan",
  seoDescription:
    "ルーヴェ ダイニングテーブル 180 は、オーク無垢材を使用した180cm幅の上質なダイニングテーブル。ナチュラルで洗練された空間を演出する拡張対応モデルです。",
  keywords: [
    "ダイニングテーブル",
    "180cm ダイニングテーブル",
    "無垢材 テーブル",
...
"natural-storage-bed-frame-120": {
  ...
  mainCategory: "ベッド",
  subCategory: "収納付きベッドフレーム",
  slug: "natural-storage-bed-frame-120",
  canonicalPath: "/products/beds/natural-storage-bed-frame-120",
  brand: "Luxe Living Japan",
  sku: "luxebed120-storage",
  price: 108900,

  name: "ナチュラル ウッド収納ベッドフレーム 120",
  seoTitle: "ナチュラル ウッド収納ベッドフレーム 120 | 収納付き木製ベッド | Luxe Living Japan",
  seoDescription:
    "ナチュラル ウッド収納ベッドフレーム 120 は、跳ね上げ収納と宮棚付きデザインを備えた天然木ベッド。シングルからキングまで対応し、機能性と上質感を両立します。",
  keywords: [
    "ベッド",
    "収納付きベッド",
    "木製ベッド",
...
"premium-luxury-bed-frame-185": {
  ...
  mainCategory: "ベッド",
  subCategory: "高級ベッドフレーム",
  slug: "premium-luxury-bed-frame-185",
  canonicalPath: "/products/beds/premium-luxury-bed-frame-185",
  brand: "Luxe Living Japan",
  sku: "luxebed185",
  price: 174900,

  name: "プレミアム ラグジュアリーベッドフレーム 185",
  seoTitle: "プレミアム ラグジュアリーベッドフレーム 185 | 高級ベッド | Luxe Living Japan",
  seoDescription:
    "プレミアム ラグジュアリーベッドフレーム 185 は、丸みのあるフォルムとクッション性ヘッドボードが魅力の高級ベッド。シングルからキングまで対応し、ホテルライクな寝室を演出します。",
  keywords: [
    "ベッド",
    "高級ベッド",
    "ラグジュアリーベッド",
...
"premium-luxury-bed-frame-140-single": {
  ...
  mainCategory: "ベッド",
  subCategory: "ダブルベッドフレーム",
  slug: "premium-luxury-bed-frame-140-single",
  canonicalPath: "/products/beds/premium-luxury-bed-frame-140-single",
  brand: "Luxe Living Japan",
  sku: "luxebed140-single",
  price: 174900,

  name: "プレミアム ラグジュアリーベッドフレーム 140",
  seoTitle: "プレミアム ラグジュアリーベッドフレーム 140 | ダブル対応 高級ベッド | Luxe Living Japan",
  seoDescription:
    "プレミアム ラグジュアリーベッドフレーム 140 は、ダブル（140cmマットレス対応）の高級ベッドフレーム。丸みのあるフォルムとクッション性ヘッドボードで、ホテルライクな寝室を演出します。",
  keywords: [
    "ベッド",
    "高級ベッド",
    "ベッドフレーム",
...
"premium-luxury-bed-frame-140-fixed": {
  ...
  mainCategory: "ベッド",
  subCategory: "ダブルベッドフレーム",
  slug: "premium-luxury-bed-frame-140-fixed",
  canonicalPath: "/products/beds/premium-luxury-bed-frame-140-fixed",
  brand: "Luxe Living Japan",
  ...
  seoTitle: "プレミアム ラグジュアリーベッドフレーム 140 | ダブル対応 高級ベッド | Luxe Living Japan",
  seoDescription:
    "プレミアム ラグジュアリーベッドフレーム 140 は、ダブル（140cmマットレス対応）の高級ベッドフレーム。丸みのあるフォルムと上質な張り地で、洗練されたホテルライクな寝室を演出します。",
  keywords: [
    "ベッド",
    "高級ベッド",
    "ベッドフレーム",
...
"modern-luxury-bed-frame-120": {
  ...
  mainCategory: "ベッド",
  subCategory: "高級ベッドフレーム",
  slug: "modern-luxury-bed-frame-120",
  canonicalPath: "/products/beds/modern-luxury-bed-frame-120",
  brand: "Luxe Living Japan",
  sku: "luxebed120-modern",
  price: 174900,

  name: "モダン ラグジュアリーベッドフレーム 120",
  seoTitle: "モダン ラグジュアリーベッドフレーム 120 | 高級モダンベッド | Luxe Living Japan",
  seoDescription:
    "モダン ラグジュアリーベッドフレーム 120 は、クッション性ヘッドボードと静音設計を備えた高級ベッドフレーム。シングルからキングまで対応し、上質な寝室空間を演出します。",
  keywords: [
    "ベッド",
    "高級ベッド",
    "モダン ベッド",
...
"louve-dining-table-set-140": {
  category: "ダイニングセット",
  mainCategory: "ダイニングセット",
  subCategory: "無垢材ダイニングセット",
  slug: "louve-dining-table-set-140",
  canonicalPath: "/products/dining/louve-dining-table-set-140",
  brand: "Luxe Living Japan",
  sku: "luxeds140",
  price: 218900,

  name: "ルーヴェ ダイニングテーブルセット",
  seoTitle: "ルーヴェ ダイニングテーブルセット | 無垢材 伸長式ダイニングセット | Luxe Living Japan",
  seoDescription:
    "ルーヴェ ダイニングテーブルセットは、オーク無垢材とバタフライリーフ構造を備えた伸長式ダイニングセット。140cm・160cm・180cm展開で、上質な食空間を演出します。",
  keywords: [
    "ダイニングセット",
    "無垢材 ダイニングセット",
    "伸長式 ダイニングテーブル",
...
"luna-stone-dining-set-160": {
  category: "ダイニングセット",
  mainCategory: "ダイニングセット",
  subCategory: "ストーンダイニングセット",
  slug: "luna-stone-dining-set-160",
  canonicalPath: "/products/dining/luna-stone-dining-set-160",
  brand: "Luxe Living Japan",
  sku: "luna-stone-dining-set-160",
  price: 207900,

  name: "ルーナ ストーンダイニングセット 160",
  seoTitle: "ルーナ ストーンダイニングセット 160 | 5点セット モダンダイニング | Luxe Living Japan",
  seoDescription:
    "ルーナ ストーンダイニングセット 160 は、シンタードストーン天板と三日月型ベースが特徴の5点式モダンダイニングセット。洗練されたラグジュアリー空間を演出します。",
  keywords: [
    "ダイニングセット",
    "5点 ダイニングセット",
    "シンタードストーン ダイニング",
...
"wabisabi-solid-wood-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "無垢材ダイニングセット",
  slug: "wabisabi-solid-wood-dining-set",
  canonicalPath: "/products/dining/wabisabi-solid-wood-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds140-ws",
  price: 207900,

  name: "ワビサビ 無垢材ダイニングセット",
  seoTitle: "ワビサビ 無垢材ダイニングセット | 北欧モダン ダイニング | Luxe Living Japan",
  seoDescription:
    "ワビサビ 無垢材ダイニングセットは、オーク無垢材と有機的フォルムが魅力の上質なダイニングセット。140cm・160cm・180cm展開で、洗練された食空間を演出します。",
  keywords: [
    "ダイニングセット",
    "無垢材 ダイニングセット",
    "北欧 ダイニングセット",
...
"hokku-solid-wood-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "無垢材ダイニングセット",
  slug: "hokku-solid-wood-dining-set",
  canonicalPath: "/products/dining/hokku-solid-wood-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds180-140",
  price: 174900,

  name: "ホック ソリッドウッドダイニングセット",
  seoTitle: "ホック ソリッドウッドダイニングセット | 無垢材 伸長式ダイニング | Luxe Living Japan",
  seoDescription:
    "ホック ソリッドウッドダイニングセットは、オーク無垢材とバタフライリーフ構造を備えた高級ダイニングセット。140cm・160cm・180cm展開で、上質な食卓空間を演出します。",
  keywords: [
    "ダイニングセット",
    "無垢材 ダイニングセット",
    "伸長式 ダイニングセット",
...
"candy-cloud-sofa-l": {
  ...
  mainCategory: "ソファ",
  subCategory: "L字ソファ",
  slug: "candy-cloud-sofa-l",
  canonicalPath: "/products/sofas/candy-cloud-sofa-l",
  brand: "Luxe Living Japan",
  sku: "luxesofa360L-310",
  price: 482900,

  name: "キャンディ クラウドソファ L",
  seoTitle: "キャンディ クラウドソファ L | 高級 L字ソファ | Luxe Living Japan",
  seoDescription:
    "キャンディ クラウドソファ L は、丸みのあるフォルムと上質なファブリックが魅力の高級L字ソファ。310cm・350cm・380cm展開で、上質なリビング空間を演出します。",
  keywords: [
    "ソファ",
    "L字ソファ",
    "クラウドソファ",
...
"luxury-wide-sofa-392": {
  ...
  mainCategory: "ソファ",
  subCategory: "大型ソファ",
  slug: "luxury-wide-sofa-392",
  canonicalPath: "/products/sofas/luxury-wide-sofa-392",
  brand: "Luxe Living Japan",
  sku: "luxesofa392",
  price: 379000,

  name: "ラグジュアリー ワイドソファ 392",
  seoTitle: "ラグジュアリー ワイドソファ 392 | 超大型 モダンソファ | Luxe Living Japan",
  seoDescription:
    "ラグジュアリー ワイドソファ 392 は、392cmの圧倒的なサイズ感を持つ超大型モダンソファ。ゆったりとした座り心地で、上質なラグジュアリーリビングを演出します。",
  keywords: [
    "ソファ",
    "大型ソファ",
    "ワイドソファ",
...
"luxury-leather-sofa-293": {
  ...
  mainCategory: "ソファ",
  subCategory: "L字ソファ",
  slug: "luxury-leather-sofa-293",
  canonicalPath: "/products/sofas/luxury-leather-sofa-293",
  brand: "Luxe Living Japan",
  sku: "luxesofa293l",
  price: 394900,

  name: "ラグジュアリー レザーソファ 293",
  seoTitle: "ラグジュアリー レザーソファ 293 | 本革 L字ソファ | Luxe Living Japan",
  seoDescription:
    "ラグジュアリー レザーソファ 293 は、本革または高級マイクロファイバーレザーから選べる293cmのL字ソファ。上質な存在感と快適な座り心地を両立した一台です。",
  keywords: [
    "ソファ",
    "L字ソファ",
    "レザーソファ",
...
"victoria-l-sofa-275": {
  ...
  mainCategory: "ソファ",
  subCategory: "L字ソファ",
  slug: "victoria-l-sofa-275",
  canonicalPath: "/products/sofas/victoria-l-sofa-275",
  brand: "Luxe Living Japan",
  sku: "luxeLsofa275",
  price: 394900,

  name: "ヴィクトリア L字ソファ 275",
  seoTitle: "ヴィクトリア L字ソファ 275 | 高級 コーナーソファ | Luxe Living Japan",
  seoDescription:
    "ヴィクトリア L字ソファ 275 は、本革・高級マイクロファイバーレザー対応のモダンなL字ソファ。275cm・350cm展開で、洗練されたラグジュアリーリビングを演出します。",
  keywords: [
    "ソファ",
    "L字ソファ",
    "コーナーソファ",
...
"modern-luxury-l-sofa-246": {
  ...
  mainCategory: "ソファ",
  subCategory: "L字ソファ",
  slug: "modern-luxury-l-sofa-246",
  canonicalPath: "/products/sofas/modern-luxury-l-sofa-246",
  brand: "Luxe Living Japan",
  sku: "luxesofa246",
  price: 372900,

  name: "モダン ラグジュアリー L字ソファ 246",
  seoTitle: "モダン ラグジュアリー L字ソファ 246 | 高級 コーナーソファ | Luxe Living Japan",
  seoDescription:
    "モダン ラグジュアリー L字ソファ 246 は、本革・高級マイクロファイバーレザー対応の洗練されたL字型セクショナルソファ。246cm〜356cm展開で上質なリビング空間を演出します。",
  keywords: [
    "ソファ",
    "L字ソファ",
    "コーナーソファ",
...
"modern-luxury-l-sofa-250": {
  ...
  mainCategory: "ソファ",
  subCategory: "L字ソファ",
  slug: "modern-luxury-l-sofa-250",
  canonicalPath: "/products/sofas/modern-luxury-l-sofa-250",
  brand: "Luxe Living Japan",
  sku: "luxesofa250lo",
  price: 372900,

  name: "モダン ラグジュアリー L字ソファ 250",
  seoTitle: "モダン ラグジュアリー L字ソファ 250 | 高級 コーナーソファ | Luxe Living Japan",
  seoDescription:
    "モダン ラグジュアリー L字ソファ 250 は、本革・高級マイクロファイバーレザー対応の高級L字ソファ。250cm・280cm・310cm展開で、快適で上質なリビング空間を演出します。",
  keywords: [
    "ソファ",
    "L字ソファ",
    "コーナーソファ",
...
"luxury-candy-sofa-280": {
  ...
  mainCategory: "ソファ",
  subCategory: "クラウドソファ",
  slug: "luxury-candy-sofa-280",
  canonicalPath: "/products/sofas/luxury-candy-sofa-280",
  brand: "Luxe Living Japan",
  sku: "luxesofa280",
  price: 389000,

  name: "ラグジュアリー キャンディソファ 280",
  seoTitle: "ラグジュアリー キャンディソファ 280 | クラウドソファ | Luxe Living Japan",
  seoDescription:
    "ラグジュアリー キャンディソファ 280 は、丸みのあるフォルムが魅力の高級クラウドソファ。280cm〜340cm展開で、やわらかく上質なリビング空間を演出します。",
  keywords: [
    "ソファ",
    "クラウドソファ",
    "キャンディソファ",
...
"luxury-sectional-sofa-310-l": {
  ...
  mainCategory: "ソファ",
  subCategory: "L字ソファ",
  slug: "luxury-sectional-sofa-310-l",
  canonicalPath: "/products/sofas/luxury-sectional-sofa-310-l",
  brand: "Luxe Living Japan",
  sku: "luxesofa310l",
  price: 449000,

  name: "ラグジュアリー モダン L字型セクショナルソファ 310",
  seoTitle: "ラグジュアリー モダン L字型セクショナルソファ 310 | 高級 L字ソファ | Luxe Living Japan",
  seoDescription:
    "ラグジュアリー モダン L字型セクショナルソファ 310 は、高級ファブリックを使用した上質なモジュラー式コーナーソファ。310cm・358cm展開で洗練された空間を演出します。",
  keywords: [
    "ソファ",
    "L字ソファ",
    "セクショナルソファ",
...
"luna-round-dining-set": {
  category: "ダイニングセット",
  mainCategory: "ダイニングセット",
  subCategory: "丸型ダイニングセット",
  slug: "luna-round-dining-set",
  canonicalPath: "/products/dining/luna-round-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds130-120",
  price: 196900,

  name: "ルナ ラウンドダイニングセット",
  seoTitle: "ルナ ラウンドダイニングセット | 丸型 ダイニングセット | Luxe Living Japan",
  seoDescription:
    "ルナ ラウンドダイニングセットは、シンタードストーン天板と彫刻的ベースが魅力の高級丸型ダイニングセット。120cm・150cm展開で洗練された食空間を演出します。",
  keywords: [
    "ダイニングセット",
    "丸型 ダイニングセット",
    "ラウンドダイニング",
  ...
  infoDescription:
    "ラグジュアリーなルナ ラウンドダイニングセットは、現代的なデザインが特徴です。天板にはポリッシュ仕上げのシンタードストーンを使用し、リアルな石目模様を再現しています。ベース部分はブラックチタン、木材、ステンレススチールを組み合わせた彫刻的なペデスタルデザインです。セットには、回転式のレイジースーザン（中央回転トレー）が内蔵されています。サイズは直径120cmまたは150cmで、4〜6名用です。",
  material:
...
"silas-round-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "丸型ダイニングセット",
  slug: "silas-round-dining-set",
  canonicalPath: "/products/dining/silas-round-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds120-120",
  price: 141900,

  name: "シラス ラウンドダイニングセット",
  seoTitle: "シラス ラウンドダイニングセット | 丸型 モダンダイニング | Luxe Living Japan",
  seoDescription:
    "シラス ラウンドダイニングセットは、シンタードストーン天板とホワイトチェアを組み合わせた上質な丸型ダイニングセット。120cm・150cm展開で明るく洗練された空間を演出します。",
  keywords: [
    "ダイニングセット",
    "丸型 ダイニングセット",
    "ホワイト ダイニングセット",
...
"claz-sintered-stone-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "ストーンダイニングセット",
  slug: "claz-sintered-stone-dining-set",
  canonicalPath: "/products/dining/claz-sintered-stone-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds160-140",
  price: 130900,

  name: "クラズ シンタードストーンダイニングセット",
  seoTitle: "クラズ シンタードストーンダイニングセット | モダンダイニングセット | Luxe Living Japan",
  seoDescription:
    "クラズ シンタードストーンダイニングセットは、大理石調天板とフルーテッドベースが印象的なモダンダイニングセット。140cm・160cm・180cm展開で上質な食空間を演出します。",
  keywords: [
    "ダイニングセット",
    "シンタードストーン ダイニング",
    "モダンダイニングセット",
...
"elegant-round-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "丸型ダイニングセット",
  slug: "elegant-round-dining-set",
  canonicalPath: "/products/dining/elegant-round-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds120-120",
  price: 141900,

  name: "エレガント ラウンドダイニングセット",
  seoTitle: "エレガント ラウンドダイニングセット | 丸型 ダイニングセット | Luxe Living Japan",
  seoDescription:
    "エレガント ラウンドダイニングセットは、シンタードストーン天板と彫刻的メタルベースが魅力の高級丸型ダイニングセット。120cm・150cm展開で洗練された食空間を演出します。",
  keywords: [
    "ダイニングセット",
    "丸型 ダイニングセット",
    "ラウンドダイニング",
...
"double-v-round-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "丸型ダイニングセット",
  slug: "double-v-round-dining-set",
  canonicalPath: "/products/dining/double-v-round-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds130-120",
  price: 163900,

  name: "ダブルV ラウンドダイニングセット",
  seoTitle: "ダブルV ラウンドダイニングセット | 丸型 ダイニングセット | Luxe Living Japan",
  seoDescription:
    "ダブルV ラウンドダイニングセットは、ホワイトマーブル調天板と印象的なダブルV字ベースが魅力の高級丸型ダイニングセット。120cm・150cm展開で華やかな食空間を演出します。",
  keywords: [
    "ダイニングセット",
    "丸型 ダイニングセット",
    "ラウンドダイニング",
  ...
  infoDescription:
    "モダンでエレガントなホワイトマーブル調またはシンタードストーン天板に、特徴的なダブルV字ベースのメタルペデスタル脚を組み合わせたデザインです。中央には回転式のレイジースーザン（ターンテーブル）が内蔵されており、料理の取り分けにも便利です。大理石天板へアップグレードの場合は＋50,000円となります。天板は天然大理石、人工大理石、または高硬度シンタードストーンを使用しており、耐久性・耐熱性に優れています。脚部はブラックまたはゴールドのメタルペデスタル仕様で、幾何学的なダブルV字ベース構造により高い安定性と強度を実現しております。6〜8名用で、一般的なサイズは直径130cmまたは150cmです。",
  material:
...
"curve-pedestal-round-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "丸型ダイニングセット",
  slug: "curve-pedestal-round-dining-set",
  canonicalPath: "/products/dining/curve-pedestal-round-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds120-curve-120",
  price: 163900,

  name: "カーブペデスタル ラウンドダイニングセット",
  seoTitle: "カーブペデスタル ラウンドダイニングセット | 丸型 ダイニング | Luxe Living Japan",
  seoDescription:
    "カーブペデスタル ラウンドダイニングセットは、ホワイトストーン天板と彫刻的なカーブベースが魅力の高級丸型ダイニングセット。120cm・150cm展開で洗練された空間を演出します。",
  keywords: [
    "ダイニングセット",
    "丸型 ダイニングセット",
    "ラウンドダイニング",
...
"pandora-round-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "丸型ダイニングセット",
  slug: "pandora-round-dining-set",
  canonicalPath: "/products/dining/pandora-round-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds120-pandora-120",
  price: 141900,

  name: "パンドラ ラウンドダイニングセット",
  seoTitle: "パンドラ ラウンドダイニングセット | 丸型 ダイニングセット | Luxe Living Japan",
  seoDescription:
    "パンドラ ラウンドダイニングセットは、シンタードストーン天板とX型ペデスタルベースが魅力の高級丸型ダイニングセット。120cm・150cm展開で洗練された空間を演出します。",
  keywords: [
    "ダイニングセット",
    "丸型 ダイニングセット",
    "ラウンドダイニング",
...
"luxury-round-dining-set-120": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "丸型ダイニングセット",
  slug: "luxury-round-dining-set-120",
  canonicalPath: "/products/dining/luxury-round-dining-set-120",
  brand: "Luxe Living Japan",
  sku: "luxeds120-round-luxury",
  price: 218900,

  name: "ラグジュアリー ラウンドダイニングセット 120",
  seoTitle: "ラグジュアリー ラウンドダイニングセット 120 | 丸型 ダイニングセット | Luxe Living Japan",
  seoDescription:
    "ラグジュアリー ラウンドダイニングセット 120 は、一体型レイジーサン付きのマーブル調丸型ダイニングセット。チェア4脚付きで高級感あふれる食空間を演出します。",
  keywords: [
    "ダイニングセット",
    "丸型 ダイニングセット",
    "ラウンドダイニング",
...
"butterfly-ceramic-dining-set-160": {
  category: "ダイニングセット",
  mainCategory: "ダイニングセット",
  subCategory: "セラミックダイニングセット",
  slug: "butterfly-ceramic-dining-set-160",
  canonicalPath: "/products/dining/butterfly-ceramic-dining-set-160",
  brand: "Luxe Living Japan",
  sku: "luxeds160-butterfly-140",
  price: 284900,

  name: "バタフライ セラミックダイニングセット 160",
  seoTitle: "バタフライ セラミックダイニングセット 160 | 高級 セラミックダイニング | Luxe Living Japan",
  seoDescription:
    "バタフライ セラミックダイニングセット 160 は、蝶を思わせる彫刻的ベースが魅力の高級セラミックダイニングセット。140cm・160cm・180cm展開で洗練された空間を演出します。",
  keywords: [
    "ダイニングセット",
    "セラミック ダイニングセット",
    "高級 ダイニングセット",
...
"gold-cage-round-dining-set": {
  ...
  mainCategory: "ダイニングセット",
  subCategory: "丸型ダイニングセット",
  slug: "gold-cage-round-dining-set",
  canonicalPath: "/products/dining/gold-cage-round-dining-set",
  brand: "Luxe Living Japan",
  sku: "luxeds120-goldcage-120",
  price: 163900,

  name: "ゴールドケージ ラウンドダイニングセット",
  seoTitle: "ゴールドケージ ラウンドダイニングセット | 丸型 ダイニングセット | Luxe Living Japan",
  seoDescription:
    "ゴールドケージ ラウンドダイニングセットは、シンタードストーン天板とゴールドスチールベースが魅力の高級丸型ダイニングセット。120cm・150cm展開で華やかな空間を演出します。",
  keywords: [
    "ダイニングセット",
    "丸型 ダイニングセット",
    "ラウンドダイニング",
...
"luxo-curve-sofa": {
  ...
  mainCategory: "ソファ",
  subCategory: "カーブソファ",
  slug: "luxo-curve-sofa",
  canonicalPath: "/products/sofas/luxo-curve-sofa",
  brand: "Luxe Living Japan",
  sku: "luxesofa120-120",
  price: 196900,

  name: "ルクソ カーブソファ",
  seoTitle: "ルクソ カーブソファ | カーブソファ・モダンソファ | Luxe Living Japan",
  seoDescription:
    "ルクソ カーブソファは、やわらかな曲線フォルムが魅力のモダンカーブソファ。120cmから310cmまで展開し、上質で心地よいリビング空間を演出します。",
  keywords: [
    "ソファ",
    "カーブソファ",
    "モダンソファ",
...
"luxury-modern-curve-sofa-140": {
  ...
  mainCategory: "ソファ",
  subCategory: "カーブソファ",
  slug: "luxury-modern-curve-sofa-140",
  canonicalPath: "/products/sofas/luxury-modern-curve-sofa-140",
  brand: "Luxe Living Japan",
  sku: "luxesofa140-140",
  price: 262900,

  name: "ラグジュアリー モダン カーブソファ 140",
  seoTitle: "ラグジュアリー モダン カーブソファ 140 | 高級カーブソファ | Luxe Living Japan",
  seoDescription:
    "ラグジュアリー モダン カーブソファ 140 は、洗練された曲線美とチャンネルデザインが魅力の高級カーブソファ。140cmから340cmまで展開し、上質な空間を演出します。",
  keywords: [
    "ソファ",
    "カーブソファ",
    "モダンソファ",
...
"victoria-sofa-200": {
  ...
  mainCategory: "ソファ",
  subCategory: "3人掛けソファ",
  slug: "victoria-sofa-200",
  canonicalPath: "/products/sofas/victoria-sofa-200",
  brand: "Luxe Living Japan",
  sku: "luxesofa200-200",
  price: 251900,

  name: "ヴィクトリア ソファ 200",
  seoTitle: "ヴィクトリア ソファ 200 | 3人掛け モダンソファ | Luxe Living Japan",
  seoDescription:
    "ヴィクトリア ソファ 200 は、チャンネルタフテッドデザインが魅力の高級3人掛けソファ。200cmから300cmまで展開し、上質で洗練されたリビング空間を演出します。",
  keywords: [
    "ソファ",
    "3人掛けソファ",
    "モダンソファ",
...
"stylish-sofa-210": {
  ...
  mainCategory: "ソファ",
  subCategory: "3人掛けソファ",
  slug: "stylish-sofa-210",
  canonicalPath: "/products/sofas/stylish-sofa-210",
  brand: "Luxe Living Japan",
  sku: "luxesofa210-180",
  price: 196900,

  name: "スタイリッシュソファ 210",
  seoTitle: "スタイリッシュソファ 210 | モダン 3人掛けソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュソファ 210 は、広々とした座面とロープロファイルが魅力のモダンソファ。180cmから300cmまで展開し、上品で洗練されたリビング空間を演出します。",
  keywords: [
    "ソファ",
    "3人掛けソファ",
    "モダンソファ",
...
"stylish-sofa-300": {
  ...
  mainCategory: "ソファ",
  subCategory: "大型ソファ",
  slug: "stylish-sofa-300",
  canonicalPath: "/products/sofas/stylish-sofa-300",
  brand: "Luxe Living Japan",
  sku: "luxesofa300-180",
  price: 196900,

  name: "スタイリッシュソファ 300",
  seoTitle: "スタイリッシュソファ 300 | 大型モダンソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュソファ 300 は、ロープロファイルの美しいシルエットと広々とした座面が魅力の大型モダンソファ。180cmから300cmまで展開し、上質な空間を演出します。",
  keywords: [
    "ソファ",
    "大型ソファ",
    "モダンソファ",
...
"veronda-modern-luxury-sofa": {
  ...
  mainCategory: "ソファ",
  subCategory: "モダンソファ",
  slug: "veronda-modern-luxury-sofa",
  canonicalPath: "/products/sofas/veronda-modern-luxury-sofa",
  brand: "Luxe Living Japan",
  sku: "luxesofa200-200",
  price: 218900,

  name: "ヴェロンダ モダンラグジュアリーソファ",
  seoTitle: "ヴェロンダ モダンラグジュアリーソファ | モダンソファ | Luxe Living Japan",
  seoDescription:
    "ヴェロンダ モダンラグジュアリーソファは、ピロートップアームとゆったり座面が魅力の高級モダンソファ。200cm・240cm・300cm展開で上質なリビングを演出します。",
  keywords: [
    "ソファ",
    "モダンソファ",
    "高級ソファ",
...
"luxesofa300": {
  ...
  mainCategory: "ソファ",
  subCategory: "クラウドソファ",
  slug: "bubble-cloud-sofa",
  canonicalPath: "/products/sofas/bubble-cloud-sofa",
  brand: "Luxe Living Japan",
  sku: "luxesofa300-180",
  price: 262900,

  name: "バブルソファ クラウドソファ",
  seoTitle: "バブルソファ クラウドソファ | 高級クラウドソファ | Luxe Living Japan",
  seoDescription:
    "バブルソファ クラウドソファは、丸みのあるフォルムとタフト仕様が魅力の高級クラウドソファ。180cmから300cmまで展開し、上質なリビング空間を演出します。",
  keywords: [
    "ソファ",
    "クラウドソファ",
    "バブルソファ",
...
"luxesofa200": {
  ...
  mainCategory: "ソファ",
  subCategory: "クラウドソファ",
  slug: "bubble-cloud-sofa-200",
  canonicalPath: "/products/sofas/bubble-cloud-sofa-200",
  brand: "Luxe Living Japan",
  sku: "luxesofa200-210",
  price: 284900,

  name: "バブルソファ クラウドソファ 200",
  seoTitle: "バブルソファ クラウドソファ 200 | 高級クラウドソファ | Luxe Living Japan",
  seoDescription:
    "バブルソファ クラウドソファ 200 は、丸みのあるフォルムとタフト仕様が魅力の高級クラウドソファ。210cmから280cmまで展開し、上質な空間を演出します。",
  keywords: [
    "ソファ",
    "クラウドソファ",
    "バブルソファ",
...
"luxesofa150l": {
  category: "ソファ",
  mainCategory: "ソファ",
  subCategory: "コンパクトソファ",
  slug: "compact-leather-sofa-150",
  canonicalPath: "/products/sofas/compact-leather-sofa-150",
  brand: "Luxe Living Japan",
  sku: "luxesofa150l-150",
  price: 185900,

  name: "コンパクト 3人掛けソファ 150cm レザー",
  seoTitle: "コンパクト 3人掛けソファ 150cm レザー | 小型ソファ | Luxe Living Japan",
  seoDescription:
    "コンパクト 3人掛けソファ 150cm レザーは、省スペースでも上質感を演出できるモダンレザーソファ。150cmから310cmまで展開し、一人暮らしや1LDKにもおすすめです。",
  keywords: [
    "ソファ",
    "コンパクトソファ",
    "3人掛けソファ",
  ...
  infoDescription:
    "モダンラグジュアリーソファ、2〜2.5Pソファ（アパートやリビングルームに最適、ホワイト）。人間工学に基づいた湾曲した背もたれは、さまざまな座り姿勢に優れたサポートを提供し、腰を快適に保ちます。柔らかなパッド入りのシートは、長時間の会話、読書、映画鑑賞でも快適な座り心地を実現します。高反発ウレタンスポンジと厳選された無垢材を使用し、強度と耐久性を兼ね備えた構造です。高反発ウレタンスポンジが体圧を分散し、長時間座っても疲れにくい設計となっております。洗練されたオールインワンのシルエットが特徴で、リビングルーム、寝室、オフィス、応接室、ラウンジなど、さまざまな空間に最適です。高品質の木材とスプリングで補強されたクッションを採用し、優れた座り心地を提供します。生地は摩耗、汚れ、こぼれに強く、日常使いにも適しています。",
  material:
...
"luxesofa210b": {
  ...
  mainCategory: "ソファ",
  subCategory: "カーブソファ",
  slug: "boucle-curve-sofa-210",
  canonicalPath: "/products/sofas/boucle-curve-sofa-210",
  brand: "Luxe Living Japan",
  sku: "luxesofa210b-170",
  price: 185900,

  name: "ブークレ素材 210cm カーブソファ",
  seoTitle: "ブークレ素材 210cm カーブソファ | モダンソファ | Luxe Living Japan",
  seoDescription:
    "ブークレ素材 210cm カーブソファは、やわらかな曲線美と上質な素材感が魅力のモダンカーブソファ。170cmから300cmまで展開し、洗練された空間を演出します。",
  keywords: [
    "ソファ",
    "カーブソファ",
    "ブークレ ソファ",
...
"luxesofa115": {
  category: "ソファ",
  mainCategory: "ソファ",
  subCategory: "セクショナルソファ",
  slug: "cloud-style-sectional-sofa",
  canonicalPath: "/products/sofas/cloud-style-sectional-sofa",
  brand: "Luxe Living Japan",
  sku: "luxesofa115-115",
  price: 196900,

  name: "クラウドスタイル セクショナルソファ",
  seoTitle: "クラウドスタイル セクショナルソファ | モジュールソファ | Luxe Living Japan",
  seoDescription:
    "クラウドスタイル セクショナルソファは、ふっくらとしたクッションと自由なレイアウトが魅力のモジュールソファ。115cmから300cmまで展開し、上質なくつろぎ空間を演出します。",
  keywords: [
    "ソファ",
    "セクショナルソファ",
    "モジュールソファ",
...
"luxesofa300-stylish": {
  ...
  mainCategory: "ソファ",
  subCategory: "大型ソファ",
  slug: "stylish-sofa-300-premium",
  canonicalPath: "/products/sofas/stylish-sofa-300-premium",
  brand: "Luxe Living Japan",
  ...
  seoTitle: "スタイリッシュソファ 300 | 大型モダンソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュソファ 300 は、広々とした座面とロープロファイルの美しいシルエットが魅力の大型モダンソファ。220cmから300cmまで展開し、洗練されたリビング空間を演出します。",
  keywords: [
    "ソファ",
    "大型ソファ",
    "300cm ソファ",
...
"luxesofa300a": {
  ...
  mainCategory: "ソファ",
  subCategory: "大型ソファ",
  slug: "stylish-sofa-300a",
  canonicalPath: "/products/sofas/stylish-sofa-300a",
  brand: "Luxe Living Japan",
  sku: "luxesofa300a-220",
  price: 306900,

  name: "スタイリッシュソファ 300A",
  seoTitle: "スタイリッシュソファ 300A | モダン大型ソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュソファ 300A は、ロープロファイルの美しいシルエットと広々とした座面が魅力のモダン大型ソファ。220cmから300cmまで展開し、上質な空間づくりにおすすめです。",
  keywords: [
    "ソファ",
    "大型ソファ",
    "300cm ソファ",
...
"luxesofa240a": {
  ...
  mainCategory: "ソファ",
  subCategory: "モダンソファ",
  slug: "stylish-sofa-240a",
  canonicalPath: "/products/sofas/stylish-sofa-240a",
  brand: "Luxe Living Japan",
  sku: "luxesofa240a-220",
  price: 284900,

  name: "スタイリッシュソファ 240A",
  seoTitle: "スタイリッシュソファ 240A | モダンソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュソファ 240A は、ロープロファイルのシルエットと広々とした座面が魅力のモダンソファ。220cmから300cmまで展開し、上品なリビング空間を演出します。",
  keywords: [
    "ソファ",
    "240cm ソファ",
    "モダンソファ",
...
"luxesofa240b": {
  ...
  mainCategory: "ソファ",
  subCategory: "モダンソファ",
  slug: "stylish-sofa-240b",
  canonicalPath: "/products/sofas/stylish-sofa-240b",
  brand: "Luxe Living Japan",
  sku: "luxesofa240b-220",
  price: 251900,

  name: "スタイリッシュソファ 240B",
  seoTitle: "スタイリッシュソファ 240B | モダンソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュソファ 240B は、ロープロファイルの美しいシルエットと快適な座面を備えたモダンソファ。220cmから300cmまで展開し、上質な空間に調和します。",
  keywords: [
    "ソファ",
    "240cm ソファ",
    "モダンソファ",
...
"stylish-sofa-240-105-80": {
  ...
  mainCategory: "ソファ",
  subCategory: "モダンソファ",
  slug: "stylish-sofa-240",
  canonicalPath: "/products/sofas/stylish-sofa-240",
  brand: "Luxe Living Japan",
  sku: "LuxeSofa210",
  price: 295900,

  name: "スタイリッシュソファ 240",
  seoTitle: "スタイリッシュソファ 240 | モダンイタリアンソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュソファ 240 は、広々とした座面とロープロファイルの美しいシルエットが魅力のモダンソファ。210cmから300cmまで展開し、洗練されたリビングを演出します。",
  keywords: [
    "ソファ",
    "240cm ソファ",
    "モダンソファ",
...
"stylish-sofa-140-95-63": {
  ...
  mainCategory: "ソファ",
  subCategory: "コンパクトソファ",
  slug: "stylish-sofa-140",
  canonicalPath: "/products/sofas/stylish-sofa-140",
  brand: "Luxe Living Japan",
  sku: "luxesofa140a-140",
  price: 185900,

  name: "スタイリッシュソファ 140",
  seoTitle: "スタイリッシュソファ 140 | コンパクトモダンソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュソファ 140 は、ロープロファイルの美しいシルエットと快適な座面を備えたコンパクトモダンソファ。140cmから300cmまで展開し、上質な空間づくりにおすすめです。",
  keywords: [
    "ソファ",
    "140cm ソファ",
    "コンパクトソファ",
...
"stylish-curve-luxo-living-sofa-120": {
  ...
  mainCategory: "ソファ",
  subCategory: "カーブソファ",
  slug: "stylish-curve-luxo-living-sofa-120",
  canonicalPath: "/products/sofas/stylish-curve-luxo-living-sofa-120",
  brand: "Luxe Living Japan",
  sku: "luxesofa120luxo-120",
  price: 229900,

  name: "スタイリッシュ カーブ ルクソ リビングルームソファ",
  seoTitle: "スタイリッシュ カーブ ルクソ リビングルームソファ | Luxe Living Japan",
  seoDescription:
    "スタイリッシュ カーブ ルクソ リビングルームソファは、波のような立体クッションと美しい曲線が魅力のモダンカーブソファ。120cmから310cmまで展開します。",
  keywords: [
    "ソファ",
    "カーブソファ",
    "モダンソファ",
...
"pocket-coil-mattress-25cm": {
  category: "マットレス",
  mainCategory: "マットレス",
  subCategory: "ポケットコイルマットレス",
  slug: "pocket-coil-mattress-25cm",
  canonicalPath: "/products/mattresses/pocket-coil-mattress-25cm",
  brand: "Luxe Living Japan",
  sku: "luxemattress-pocket25-s",
  price: 59000,

  name: "25cm厚 ピロートップ ポケットコイルマットレス",
  seoTitle: "25cm厚 ピロートップ ポケットコイルマットレス | Luxe Living Japan",
  seoDescription:
    "25cm厚 ピロートップ ポケットコイルマットレスは、体圧分散に優れたホテルライクな寝心地が魅力。シングルからキングまで展開する高品質マットレスです。",
  keywords: [
    "マットレス",
    "ポケットコイルマットレス",
    "25cm マットレス",
...
"latex-mattress-25cm": {
  category: "マットレス",
  mainCategory: "マットレス",
  subCategory: "ラテックスマットレス",
  slug: "latex-mattress-25cm",
  canonicalPath: "/products/mattresses/latex-mattress-25cm",
  brand: "Luxe Living Japan",
  sku: "luxemattress-latex25-s",
  price: 89000,

  name: "25cm厚 ピロートップ 天然ラテックスマットレス",
  seoTitle: "25cm厚 ピロートップ 天然ラテックスマットレス | Luxe Living Japan",
  seoDescription:
    "25cm厚 ピロートップ 天然ラテックスマットレスは、体圧分散と反発力のバランスに優れた高級マットレス。ホテルライクな寝心地を求める方におすすめです。",
  keywords: [
    "マットレス",
    "ラテックスマットレス",
    "天然ラテックス",
...
"lagos-dining-set-160": {
  category: "ダイニングセット",
  mainCategory: "ダイニングセット",
  subCategory: "5点ダイニングセット",
  slug: "lagos-dining-set-160",
  canonicalPath: "/products/dining-sets/lagos-dining-set-160",
  brand: "Luxe Living Japan",
  sku: "lagos-dining-set-160",
  price: 361900,

  name: "ラゴス ダイニングセット 160",
  seoTitle: "ラゴス ダイニングセット 160 | 5点式モダンダイニングセット | Luxe Living Japan",
  seoDescription:
    "ラゴス ダイニングセット 160 は、変形楕円の天板と3本の円柱脚が印象的な5点式モダンダイニングセット。シンタードストーン天板と洗練されたデザインで上質な空間を演出します。",
  keywords: [
    "ダイニングセット",
    "5点ダイニングセット",
    "モダンダイニングセット",
...
function upsertLinkTag(relValue, hrefValue) {
  if (!relValue) return;
...
function injectProductJsonLd(product, selectedSize, finalPrice) {
  if (!product) return;

  removeExistingProductJsonLd();

  const variant = applyVariant(product, selectedSize);
  const images = Array.isArray(product.images)
    ? product.images.map((img) => buildAbsoluteUrl(img))
    : [];
  ...
  script.textContent = JSON.stringify({
    ...
    brand: {
      "@type": "Brand",
      name: product.brand || "Luxe Living Japan"
    },
    ...
    offers: {
      ...
      url: buildAbsoluteUrl(product.canonicalPath || window.location.pathname),
...
function updateSeoForProduct(product, selectedSize, finalPrice) {
  if (!product) return;

  const canonicalPath = product.canonicalPath || window.location.pathname;
  const canonicalUrl = buildAbsoluteUrl(canonicalPath);

  const firstImage =
    Array.isArray(product.images) && product.images[0]
      ? buildAbsoluteUrl(product.images[0])
      : buildAbsoluteUrl("/images/logo.jpg");

  document.title =
    product.seoTitle || `${product.name || "商品"} | Luxe Living Japan`;
  ...
  if (Array.isArray(product.keywords) && product.keywords.length > 0) {
    upsertMetaTag("name", "keywords", product.keywords.join(", "));
  }

  upsertLinkTag("canonical", canonicalUrl);

  upsertMetaTag("property", "og:type", "product");
  upsertMetaTag("property", "og:title", product.seoTitle || product.name || "");
  upsertMetaTag(
    "property",
    "og:description",
    product.seoDescription || product.description || ""
  ...
  upsertMetaTag("name", "twitter:image", firstImage);

  injectProductJsonLd(product, selectedSize, finalPrice);
}
...
function updateCartItemQuantity(index, change) {
  ...
  cart[index].quantity =
    Number(cart[index].quantity || 0) + Number(change || 0);
...
function renderCartPage() {
  ...
  cart.forEach((item, index) => {
    ...
    subtotal += unitTotal * Number(item.quantity || 0);
    ...
    card.innerHTML = `
      <div
        ...
        style="background-image: url('${escapeHtml(getCartItemImage(item))}');"
      ></div>

      <div class="cart-item-info">
        <h3>${escapeHtml(item.name || "商品")}</h3>
        <p class="cart-item-meta">カラー: ${escapeHtml(item.color || "-")}</p>
        <p class="cart-item-meta">サイズ: ${escapeHtml(item.size || "-")}</p>
        ${
          item.storageType
            ? `<p class="cart-item-meta">収納: ${escapeHtml(item.storageType)}</p>`
            : ""
        }
        ${
          item.chairType
            ? `<p class="cart-item-meta">椅子: ${escapeHtml(item.chairType)}</p>`
            : ""
        }
        <p class="cart-item-meta">マットレス: ${
          item.mattressType
            ? `${escapeHtml(item.mattressType)} (${formatPrice(
                item.mattressPrice || 0
              )})`
            : "追加なし"
        }</p>
        ...
        <div class="cart-qty-control">
          ...
          <span class="cart-qty-value">${Number(item.quantity || 0)}</span>
        ...
        <p class="cart-item-total">合計: ${formatPrice(
          unitTotal * Number(item.quantity || 0)
        )}</p>
      </div>
  ...
  cartItemsContainer.querySelectorAll(".increase-qty-btn").forEach((button) => {
    button.addEventListener("click", () => {
      updateCartItemQuantity(Number(button.dataset.index), 1);
    });
  });
...
function updateStorageUI(product, selectedSize) {
  ...
  const hasStorageOption = Boolean(product && product.storageOptions);
...
function getChairPrice(product, selectedSize, chairType) {
  if (!product || !product.chairOptions) return null;
...
function updateChairUI(product, selectedSize) {
  ...
  const hasChairOption = Boolean(product && product.chairOptions);
...
function getMattressPrice(product, selectedSize, mattressType) {
  if (!product || !product.hasMattressOption || !product.mattressOptions) {
    return 0;
  }
...
function updateMattressUI(product, selectedSize) {
  ...
  const isBedWithMattress = Boolean(product && product.hasMattressOption);
  ...
  if (mattressToggle.value === "add") {
    ...
    if (mattressPriceText) {
      mattressPriceText.textContent = `マットレス価格: ${formatPrice(
        mattressPrice
      )}`;
    }
...
function applyShopFilters() {
  ...
  cards.forEach((card) => {
    ...
    const isVisible = categoryMatch && spaceMatch && priceMatch && keywordMatch;
...
function updateProductPrice(product, selectedSize) {
  ...
  const variant = applyVariant(product, selectedSize);
  let finalPrice = Number(variant.price || product.price || 0);

  if (product && product.chairOptions && chairTypeSelect) {
    const selectedChair = chairTypeSelect.value || "無";
    const chairPrice = getChairPrice(product, selectedSize, selectedChair);
    finalPrice = chairPrice !== null ? chairPrice : Number(variant.price || 0);

    if (productSummary) {
      productSummary.dataset.chairType = selectedChair;
      productSummary.dataset.storageType = "";
    }
  } else if (product && product.storageOptions && storageTypeSelect) {
    ...
    finalPrice = storagePrice !== null ? storagePrice : Number(variant.price || 0);
...
function renderDynamicProductPage() {
  ...
  if (productThumbs.length > 0) {
    productThumbs.forEach((thumb, index) => {
      const image = Array.isArray(product.images) ? product.images[index] : "";
...
function buildCheckoutPayloadFromCartItem(item) {
  return {
    ...
    selectedStorage: item.storageType || "",
    selectedChair: item.chairType || "",
    selectedMattress: item.mattressType || "",
    mattressPrice: Number(item.mattressPrice || 0)
  };
}
